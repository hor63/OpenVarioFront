...
#ifndef GLProgControlSimpleFill_H_
#define GLProgControlSimpleFill_H_

#include "GLPrograms/GLProgBase.h"

namespace OevGLES {

/** \brief GL program for simple fill with ambient light coloring
 *
 */
class GLProgControlSimpleFill :public GLProgBase {
public:
	virtual ~GLProgControlSimpleFill();
	 ...
	 */
	static GLProgControlSimpleFill *getProgram();
...
private:
	...
	static GLProgControlSimpleFill* theProgram;

	// The uniforms
	GLProgram::ShaderVariableInfo	mvpMatrixInfo;
	GLint 							mvpMatrixLocation = 0;
	GLProgram::ShaderVariableInfo	fillColorInfo;
	GLint							fillColorLocation = 0;
...
#endif /* GLProgControlSimpleFill_H_ */
