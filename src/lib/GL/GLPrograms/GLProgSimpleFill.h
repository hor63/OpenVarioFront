...
#ifndef GLProgSimpleFill_H_
#define GLProgSimpleFill_H_
 ...
 *
 */
class GLProgSimpleFill :public GLProgBase {
public:
	virtual ~GLProgSimpleFill();
	 ...
	 */
	static GLProgSimpleFill *getProgram();
...
private:
	...
	static GLProgSimpleFill* theProgram;
