...
#ifndef GLProgDiffLightCircle_H_
#define GLProgDiffLightCircle_H_
 ...
 *
 */
class GLProgDiffLightCircle :public GLProgBase {
public:
	virtual ~GLProgDiffLightCircle();
	 ...
	 */
	static GLProgDiffLightCircle *getProgram();
	...
	GLProgram::ShaderVariableInfo  const &getIsSecondaryVertexInfo() const {
		return isSecondaryVertexInfo;
	}
	GLint getIsSecondaryVertexLocation () const {
		return isSecondaryVertexLocation;
	}
...
#endif /* GLProgDiffLightCircle_H_ */
